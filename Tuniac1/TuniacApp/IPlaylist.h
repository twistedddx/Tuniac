...
#define PLAYLIST_TYPE_MIC					4
#define PLAYLIST_TYPE_CD					5
//#define PLAYLIST_TYPE_RADIO				6
//#define PLAYLIST_TYPE_USER				7
#define PLAYLIST_TYPE_COUNT					6
...
public:
	...
	virtual IPlaylistEntry *	GetEntryByEntryID(unsigned long ulEntryID)							= 0;
