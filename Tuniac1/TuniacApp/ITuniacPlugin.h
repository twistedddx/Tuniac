...
#define PLUGINNOTIFY_SONGPLAY			WM_USER + 0x00000004
#define PLUGINNOTIFY_SONGINFOCHANGE		WM_USER + 0x00000005
#define PLUGINNOTIFY_SEEK_MANUAL		WM_USER + 0x00000006
#define PLUGINNOTIFY_SONGPLAYED			WM_USER + 0x00000007
