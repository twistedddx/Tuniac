...
const float synthesisfilter::D[512] = 
{
...
void synthesisfilter::Reset(void)
{
...
bool synthesisfilter::PerformSynthesis(float *InputFreq, float *ToHere, int step)
{	
	...
	Vpointer = (Vpointer - 64) & 0x3ff;
	
	IDCT(InputFreq, &V[ Vpointer ]);
...
void synthesisfilter::IDCT(float *input, float *out)
{
    float odd[16];
    float t[32];
...
void synthesisfilter::Window(float *S, int step)
{
    int j, k;
    register float sum;
