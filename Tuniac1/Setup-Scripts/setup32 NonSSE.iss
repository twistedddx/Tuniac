...
AllowNoIcons=true
OutputDir=.
OutputBaseFilename=..\Tuniac_Setup32_NonSSE_{#DateTime}
...
[Files]
Source: ..\Win32\Release NonSSE\TuniacApp.exe; DestDir: {app}\; Flags: ignoreversion
Source: ..\TuniacApp\icons\*.ico; DestDir: {app}\iconsets\; Flags: recursesubdirs
Source: ..\Win32\Release NonSSE\std_InfoManager.dll; DestDir: {app}\; Flags: ignoreversion;
Source: ..\Win32\Release NonSSE\visuals\*.dll; DestDir: {app}\visuals; Flags: ignoreversion; Components: Visuals
Source: ..\Win32\Release NonSSE\mp3_Plugin.dll; DestDir: {app}\; Flags: ignoreversion; Components: Decoder_MP3
Source: ..\Win32\Release NonSSE\ogg_Plugin.dll; DestDir: {app}\; Flags: ignoreversion; Components: Decoder_OGG
Source: ..\Win32\Release NonSSE\ape_Plugin.dll; DestDir: {app}\; Flags: ignoreversion; Components: Decoder_APE
Source: ..\Win32\Release NonSSE\m4a_Plugin.dll; DestDir: {app}\; Flags: ignoreversion; Components: Decoder_M4A
Source: ..\Win32\Release NonSSE\mp3streamer_Plugin.dll; DestDir: {app}\; Flags: ignoreversion; Components: Decoder_MP3Streamer
Source: ..\Win32\Release NonSSE\importexport\m3u_Plugin.dll; DestDir: {app}\importexport\; Flags: ignoreversion; Components: ImportExport_M3U
Source: ..\Win32\Release NonSSE\importexport\pls_Plugin.dll; DestDir: {app}\importexport\; Flags: ignoreversion; Components: ImportExport_PLS
Source: ..\Win32\Release NonSSE\plugins\MSNInfo_Plugin.dll; DestDir: {app}\plugins\; Flags: ignoreversion; Components: Plugin_MSNInfo
Source: ..\Win32\Release NonSSE\plugins\NowPlayingTxt_Plugin.dll; DestDir: {app}\plugins\; Flags: ignoreversion; Components: Plugin_NowPlayingTxt
Source: ..\Win32\Release NonSSE\plugins\PopupNotify_plugin.dll; DestDir: {app}\plugins\; Flags: ignoreversion; Components: Plugin_PopupNotify
