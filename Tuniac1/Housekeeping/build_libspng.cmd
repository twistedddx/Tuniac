...
cd build32\
echo Working dir: %cd%
"%ProgramFiles%\CMake\bin\cmake" -DSPNG_STATIC=1 -DZLIB_INCLUDE_DIR=..\..\zlib\ -DZLIB_LIBRARY=..\..\zlib\Release\x86\zlibstatic.lib -G "Visual Studio 16 2019" -A Win32 ..\.
...
cd build64\
echo Working dir: %cd%
"%ProgramFiles%\CMake\bin\cmake" -DSPNG_STATIC=1 -DZLIB_INCLUDE_DIR=..\..\zlib\ -DZLIB_LIBRARY=..\..\zlib\Release\x86\zlibstatic.lib -G "Visual Studio 16 2019" -A x64 ..\.
devenv libspng.sln /project "spng_static" /Clean
devenv libspng.sln /project "spng_static" /Rebuild "Release"
